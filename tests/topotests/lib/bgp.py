    ...
    for router, rnode in tgen.routers().items():
        ...
        if addr_type in bgp_addr_type:
            ...
            show_bgp_neighbor_1 = run_frr_cmd(
                rnode,
                "show bgp {} neighbor {}".format(addr_type, neighbor_ip),
            )

            show_bgp_rtr_r1 = run_frr_cmd(rnode, "show bgp router")

            logger.info(
                "[DUT: {}]: show bgp router o/p" " o/p  {}".format(dut, show_bgp_rtr_r1)
            )
            ...
            for router_peer, rpeer in tgen.routers().items():
                ...
                show_bgp_rtr_rpeer = run_frr_cmd(rpeer, "show bgp router")
